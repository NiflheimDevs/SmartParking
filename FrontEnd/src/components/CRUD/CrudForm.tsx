...
import { createVehicle, getVehicle, updateVehicle, deleteVehicle } from "../../api";
...
const CrudForm = ({ action, onResult, openDeleteModal }: Props) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-3">
      <h3 className="text-cyan-400 font-semibold mb-3 text-lg capitalize">{action} Vehicle</h3>
      ...
      {action !== "create" && (
        <input
          ...
          className="input focus:ring-cyan-400"
          required
        />
      )}
